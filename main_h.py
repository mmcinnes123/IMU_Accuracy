...
### PLOT REPRESENTATIVE SAMPLE OF ELBOW (and shoulder) ANGLES

plot_rep_sample = True
if plot_rep_sample == True:

    torso_file_name = "JA_Torso_FUN_R1.csv"
    upper_file_name = "JA_Upper_FUN_R1.csv"
    forearm_file_name = "JA_Forearm_FUN_R1.csv"

    Torso_IMU_df, Torso_OMC_df = trim_data(torso_file_name, start_time=0, end_time=30)
    Upper_IMU_df, Upper_OMC_df = trim_data(upper_file_name, start_time=0, end_time=30)
    Forearm_IMU_df, Forearm_OMC_df = trim_data(forearm_file_name, start_time=0, end_time=30)
    ...
    plot_IMU_vs_Clus_eulers_elbow(IMU_elbow_angle1, IMU_elbow_angle2, IMU_elbow_angle3, OMC_elbow_angle1, OMC_elbow_angle2, OMC_elbow_angle3, decomp_seq='ZXY', tag='RepSamp_elbow',
                            sample_rate=100)

    # plot_IMU_vs_Clus_eulers_shoulder(IMU_shoulder_angle1, IMU_shoulder_angle2, IMU_shoulder_angle3, OMC_shoulder_angle1, OMC_shoulder_angle2, OMC_shoulder_angle3, decomp_seq='YXY', tag='RepSamp_shoulder',
    #                         sample_rate=100)